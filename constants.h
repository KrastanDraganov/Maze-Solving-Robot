...
const double CLOSE_TO_LEFT_RIGHT_WALL_DISTANCE_CM = 10.0;
const double CLOSE_TO_FRONT_WALL_DISTANCE_CM = 16.0;

const uint32_t START_FORWARD_ROTATIONS = 360;
const uint32_t DEFAULT_FORWARD_ROTATIONS = 790;
